...
write.table(Result_day,paste('meanvariance/4yearQ2/resultdaymu0=',as.character(mu0),'.txt',sep=''),row.names = FALSE)
write.table(cbind(Rolling_time_month,q_id_month),paste('meanvariance/4yearQ2/q_id_monthmu0=',as.character(mu0),'.txt',sep=''),row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),paste('meanvariance/4yearQ2/q_diag_monthmu0=',as.character(mu0),'.txt',sep=''),row.names = FALSE)

}

listsd=NULL
for (mu0 in mu0list){
global<-read.table(paste('meanvariance/4yearQ2/resultdaymu0=',as.character(mu0),'.txt',sep=''),head=TRUE)
...
write.csv(listsd,'meanvariance/4yearQ2/listsd.csv')