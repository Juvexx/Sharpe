...
# SP500[1,][1:4]
# min(SP500[,4])
# quantile(SP500[,4],0.01)
Adjusted_vol=read.csv('data/Adjusted*vol.csv')
Adjusted_vol=Adjusted_vol[,-1]


# T1=readdata(FF3,startyear=2001,startmonth=1,endyear=2023,endmonth=6)
# T2=readdata(SP500,startyear=2001,startmonth=1,endyear=2023,endmonth=6)
# T3=readdata(Adjusted_vol,startyear=2001,startmonth=1,endyear=2023,endmonth=6)
