...
write.table(cbind(Rolling_time_month,q_id_month),'meanvarianceunknown/year2/q1_id_month.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),'meanvarianceunknown/year2/q1_diag_month.txt',row.names = FALSE)
...
write.csv(listsd,'meanvarianceunknown/year2/listSRQ2.csv')