...
getwd()
dir.create('meanvarianceunknown/year1/')

write.table(Result_day,'meanvarianceunknown/year1/resultday1.txt',row.names = FALSE)
# write.table(cbind(Rolling_time_month,q_id_month),'meanvarianceunknown/year1/q_id_month.txt',row.names = FALSE)
# write.table(cbind(Rolling_time_month,q_diag_month),'meanvarianceunknown/year1/q_diag_month.txt',row.names = FALSE)
...
write.csv(listsd,'meanvarianceunknown/year1/listSRQ1.csv')