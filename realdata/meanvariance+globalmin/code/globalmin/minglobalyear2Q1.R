...
write.table(Result_day,'globalmin/resultsyear2/resultday.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_id_month),'globalmin/resultsyear2/q_id_month.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),'globalmin/resultsyear2/q_diag_month.txt',row.names = FALSE)



global<-read.table('globalmin/resultsyear2/resultday.txt',head=TRUE)
...
write.csv(listsd,'globalmin/resultsyear2/listsdQ1.csv')
