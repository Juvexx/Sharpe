...
write.table(Result_day,'globalmin/resultsyear4/resultday.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_id_month),'globalmin/resultsyear4/q_id_month.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),'globalmin/resultsyear4/q_diag_month.txt',row.names = FALSE)



global<-read.table('globalmin/resultsyear4/resultday.txt',head=TRUE)
...
write.csv(listsd,'globalmin/resultsyear4/listsdQ1.csv')
