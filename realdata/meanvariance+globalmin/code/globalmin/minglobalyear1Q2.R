...
write.table(Result_day,'globalmin/resultsyear1/resultday1.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_id_month),'globalmin/resultsyear1/q_id_month1.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),'globalmin/resultsyear1/q_diag_month1.txt',row.names = FALSE)

global<-read.table('globalmin/resultsyear1/resultday1.txt',head=TRUE)
...
write.csv(listsd,'globalmin/resultsyear1/listsdQ2.csv')