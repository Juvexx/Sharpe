...
write.table(Result_day,'meanvariance/year1/resultday1.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_id_month),'meanvariance/year1/q1_id_month.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),'meanvariance/year1/q1_diag_month.txt',row.names = FALSE)

 #########3yearsSR
global<-read.table('meanvariance/year1/resultday1.txt',head=TRUE)
...
write.csv(listsd,'meanvariance/year1/listSRQ2.csv')