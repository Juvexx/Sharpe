...
write.table(Result_day,'meanvariance/year4/resultday.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_id_month),'meanvariance/year4/q_id_month.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),'meanvariance/year4/q_diag_month.txt',row.names = FALSE)

 #########3yearsSR
global<-read.table('meanvariance/year4/resultday.txt',head=TRUE)
...
write.csv(listsd,'meanvariance/year4/listSRQ1.csv')