...
write.table(Result_day,'meanvariancemusd/Q2year2-0.4/resultday.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_id_month),'meanvariancemusd/Q2year2-0.4/q_id_month.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),'meanvariancemusd/Q2year2-0.4/q_diag_month.txt',row.names = FALSE)



global<-read.table('meanvariancemusd/Q2year2-0.4/resultday.txt',head=TRUE)
...
write.csv(listsd,'meanvariancemusd/Q2year2-0.4/listsd.csv')
