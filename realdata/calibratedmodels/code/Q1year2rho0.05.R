...
returncalibrate<-read.csv('data/returncalibrate0.05.csv')

year=2011
month=1
day=1
train_month_Sigma=24
train_month_mu=24
test_month=1
q_previous=0
q1_previous=0
...
write.table(Result_day,'meanvariancemusd/Q1year2-0.05/resultday.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_id_month),'meanvariancemusd/Q1year2-0.05/q_id_month.txt',row.names = FALSE)
write.table(cbind(Rolling_time_month,q_diag_month),'meanvariancemusd/Q1year2-0.05/q_diag_month.txt',row.names = FALSE)




global<-read.table('meanvariancemusd/Q1year2-0.05/resultday.txt',head=TRUE)
...
write.csv(listsd,'meanvariancemusd/Q1year2-0.05/listsd.csv')
