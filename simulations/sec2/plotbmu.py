...
for repeat0 in range(1000):
    pathsmall='mu/small/mu'
    listlambda,SRknown,SRunknown=getmean(pathsmall+'1repeat'+str(repeat0+1)+'.csv')
...
plt.savefig('figures/smallmu1.pdf',bbox_inches='tight')
...
for repeat0 in range(1000):
    pathsmall='mu/small/mu'
    listlambda,SRknown,SRunknown=getmean(pathsmall+'2repeat'+str(repeat0+1)+'.csv')
    listSRknown=listSRknown+np.array(SRknown)
    listSRunknown=listSRunknown+np.array(SRunknown)
    known=listSRknown/1000
    unknown=listSRunknown/1000
...
plt.savefig('figures/smallmu2.pdf',bbox_inches='tight')
...
for repeat0 in range(100):
    pathbig='mu/large/mu'
    listlambda,SRknown,SRunknown=getmean(pathbig+'1repeat'+str(repeat0+1)+'.csv')
    listSRknown=listSRknown+np.array(SRknown)
    listSRunknown=listSRunknown+np.array(SRunknown)
...
plt.savefig('figures/bigmu1.pdf',bbox_inches='tight')
...
for repeat0 in range(100):
    pathbig='mu/large/mu'
    listlambda,SRknown,SRunknown=getmean(pathbig+'2repeat'+str(repeat0+1)+'.csv')
    listSRknown=listSRknown+np.array(SRknown)
    listSRunknown=listSRunknown+np.array(SRunknown)
    known=listSRknown/100
    unknown=listSRunknown/100
...
plt.savefig('figures/bigmu2.pdf',bbox_inches='tight')
